export function Header(navigate) {
    ...
    const items = ['Explore', 'Image', 'Video', 'Workflow', 'Edit', 'Character', 'Contests', 'Vibe Motion', 'Cinema Studio', 'AI Influencer', 'Apps', 'Assist', 'Community'];
    ...
    items.forEach(item => {
        ...
        link.onclick = () => {
            ...
            else if (item === 'Workflow') navigate('workflow');
